        ...
        if (params[0].equals("rewardall_inzone")) {
            ...
            if (params[1].equals("gp")) {
                ...
                while (ita.hasNext()) {
                    ...
                    if (player.getWorldId() == admin.getWorldId()
                        && !(player.getName() == admin.getName() && GeoService.getInstance().canSee(admin, player))) {
                ...
                log.info(
                    "[eventai-rewardall_inzone] GM : " + admin.getName() + " gave GP : " + rewardAmount + " in mapId '" + admin.getWorldId() + "'");
                ...
                log.info(
                    "[eventai-rewardall_inzone] GM : " + admin.getName() + " gave AP : " + rewardAmount + " in mapId '" + admin.getWorldId() + "'");
            ...
            RequestResponseHandler requestHim = new RequestResponseHandler(admin) {
                ...
                public void acceptRequest(Creature requester, Player responder) {
                    ...
                    log.info("[eventai-reward_range] GM : " + admin.getName() + " gave TS : " + TS + " Omega : " + Omega + " GP : " + GP + " Toll : "
                        + toll + " in range of " + range + "m in mapId '" + admin.getWorldId() + "'");
                }
            ...
            if (areyousure) {
                PacketSendUtility.sendPacket(admin,
                    new SM_QUESTION_WINDOW(1300564, 0, 0,
            ...
            if (params[1].equals("gp")) {
                ...
                log.info(
                    "[eventai-rewardall_queue] GM : " + admin.getName() + " gave GP : " + rewardAmount + " in mapId '" + admin.getWorldId() + "'");
            ...
            log.info(
                "[eventai-announce_all] GM : " + admin.getName() + " announced all saying [" + actual + "] in mapId '" + admin.getWorldId() + "'");
            ...
            if (params[1].equalsIgnoreCase("all")) {
                ...
                log.info("[eventai-stop{target}] GM : " + admin.getName() + " paralyzed both [" + target.getName() + "][" + targetsTarget.getName()
                    + "] in mapId '" + admin.getWorldId() + "'");
            }
            ...
            log.info("[eventai-port2jumping] GM : " + admin.getName() + " tried to port2jumping player [" + player.getName() + "] mapId '"
                + admin.getWorldId() + "'");
