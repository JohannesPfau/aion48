...
public class Info extends AdminCommand {
    ...
    public void execute(Player admin, String... params) {
        ...
        if (target instanceof Player) {
            ...
            PacketSendUtility.sendMessage(admin, "[Stats]" + "\nPvP attack: " + pvpAttackRatio * 0.1f + "%" + " (Physical : "
                + player.getGameStats().getStat(StatEnum.PVP_PHYSICAL_ATTACK, 0).getCurrent() + " ) (Magical : "
                + player.getGameStats().getStat(StatEnum.PVP_MAGICAL_ATTACK, 0).getCurrent() + " )" + "\nPvP defend: " + pvpDefenseRatio * 0.1f + "%"
                + " (Physical: " + player.getGameStats().getStat(StatEnum.PVP_PHYSICAL_DEFEND, 0).getCurrent() + " ) (Magical : "
                ...
                + player.getGameStats().getMaxMp().getCurrent() + "\nDP: " + player.getCommonData().getDp() + " / "
                + player.getGameStats().getMaxDp().getCurrent() + "\nCast Time Boost: +"
            ...
            PacketSendUtility.sendMessage(admin,
                "[Relations to target]" + "\nisEnemy: " + admin.isEnemy(npc) + "\ncanAttack: " + RestrictionsManager.canAttack(admin, target)
                    ...
                    + TribeRelationService.isAggressive(npc, admin));
            PacketSendUtility.sendMessage(admin,
                ...
                if (template != null) {
                    ...
                    if (npc.getWalkerGroup() != null) {
                        ...
                        PacketSendUtility.sendMessage(admin, "[Group]" + "\nType: " + npc.getWalkerGroup().getWalkType() + " / XDelta: "
                            + snpc.getXDelta() + " / YDelta: " + snpc.getYDelta() + " / Index: " + snpc.getWalkerIndex());
                    }
                }
            }
            ...
            PacketSendUtility.sendMessage(admin,
                "[Info about gather]\n" + "Name: " + gather.getName() + "\nId: " + gather.getObjectTemplate().getTemplateId() + " / ObjectId: "
                    ...
                    + admin.getTarget().getY() + " / Z: " + admin.getTarget().getZ() + " / Heading: " + admin.getTarget().getHeading());
        }
    }
