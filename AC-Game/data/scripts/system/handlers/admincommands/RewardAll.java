    ...
    public void execute(Player player, String... params) {
        ...
        if (params[0].equals("any")) {
            ...
            while (Newiter.hasNext()) {
                PacketSendUtility.sendMessage(Newiter.next(),
                    "You have been rewarded " + newItem + " x [item:" + ItemToAdd + "] from GM " + player.getName());
            }
            ...
            if (itemCount > 5) {
                PacketSendUtility.sendMessage(player,
                    "You cannot send more than 5 food at same time.\nChanging the value to 5 and sending the items.");
                itemCount = 5;
            } else {
            ...
            while (Newiter.hasNext()) {
                PacketSendUtility.sendMessage(iter.next(),
                    "You have been rewarded " + itemCount + " x [item:" + ss + "] from GM " + player.getName());
            }
            ...
            while (Newiter.hasNext()) {
                PacketSendUtility.sendMessage(Newiter.next(),
                    "You have been rewarded " + itemCount + " x [item:" + 186000242 + "] from GM " + player.getName());
            }
            PacketSendUtility.sendMessage(player, "You have successfully added the items to all players.");
