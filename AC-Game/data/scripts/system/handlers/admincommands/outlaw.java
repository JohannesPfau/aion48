    ...
    public void execute(final Player admin, String... param) {
        ...
        if (param[0].equalsIgnoreCase("attackable")) {
            ...
            if (param[1].equalsIgnoreCase("all")) {
                ...
                while (ita.hasNext()) {
                    ...
                    if (player.getWorldId() == admin.getWorldId()) {
                        ...
                        PacketSendUtility.sendMessage(player,
                            "[Outlaw] : You've been changed to \"[color:Atta;1 0 0][color:ckab;1 0 0][color:le;1 0 0]\" Mode!");
                    }
                }
                PacketSendUtility.sendMessage(admin,
                    "[Outlaw] : All players in map has been changed to \"[color:Atta;1 0 0][color:ckab;1 0 0][color:le;1 0 0]\" !");
                ...
                log.info(
                    "[outlaw-attackable-cancel] GM : " + admin.getName() + " has changed all in map to Normal in mapId '" + admin.getWorldId() + "'");
            } else {
                if (!target.isInPkMode()) {
                    ...
                    refresh(target);
                    PacketSendUtility.sendMessage(admin,
                        "[Outlaw] : Player " + target.getName() + " is now in \"[color:Atta;1 0 0][color:ckab;1 0 0][color:le;1 0 0]\" Mode!");
                    PacketSendUtility.sendMessage(target,
                        "[Outlaw] : You've been changed to \"[color:Atta;1 0 0][color:ckab;1 0 0][color:le;1 0 0]\" Mode!");
                    log.info("[outlaw-attackable] GM : " + admin.getName() + " has changed the player [" + target.getName()
                        + "] to attackable in mapId '" + admin.getWorldId() + "'");
                } else {
                    target.setInPkMode(false);
                    refresh(target);
                    PacketSendUtility.sendMessage(admin,
                        "[Outlaw] : Player " + target.getName() + " is now in \"[color:Norm;1 1 1][color:al;1 1 1]\" Mode!");
                    PacketSendUtility.sendMessage(target, "[Outlaw] : You're now in \"[color:Norm;1 1 1][color:al;1 1 1]\" Mode!");
                    log.info("[outlaw-attackable] GM : " + admin.getName() + " has changed the player [" + target.getName() + "] to normal in mapId '"
                        + admin.getWorldId() + "'");
                }
            }
            ...
            if (param[1].equalsIgnoreCase("all")) {
                ...
                PacketSendUtility.sendMessage(admin,
                    "[Outlaw] : All players in map has been changed to \"[color:Neut;0 1 0][color:ral;0 1 0]\" Mode!");
                ...
                PacketSendUtility.sendMessage(admin, "[Outlaw] : All players in map has been changed to \"[color:Norm;1 1 1][color:al;1 1 1]\" !");
                log.info(
                    "[outlaw-neutral-cancel] GM : " + admin.getName() + " has changed all in map to Normal in mapId '" + admin.getWorldId() + "'");
            } else {
                if (!target.isInPvEMode()) {
                    ...
                    refresh(target);
                    PacketSendUtility.sendMessage(admin,
                        "[Outlaw] : Player " + target.getName() + " is now in \"[color:Neut;0 1 0][color:ral;0 1 0]\" Mode!");
                    PacketSendUtility.sendMessage(target, "[Outlaw] : You've been changed to \"[color:Neut;0 1 0][color:ral;0 1 0]\" Mode!");
                    log.info("[outlaw-neutral] GM : " + admin.getName() + " has changed the player [" + target.getName() + "] to Neutral in mapId '"
                        + admin.getWorldId() + "'");
                } else {
                    target.setInPvEMode(false);
                    refresh(target);
                    PacketSendUtility.sendMessage(admin,
                        "[Outlaw] : Player " + target.getName() + " is now in \"[color:Norm;1 1 1][color:al;1 1 1]\" Mode!");
                    PacketSendUtility.sendMessage(target, "[Outlaw] : You're now in \"[color:Norm;1 1 1][color:al;1 1 1]\" Mode!");
                    log.info("[outlaw-neutral] GM : " + admin.getName() + " has changed the player [" + target.getName() + "] to Normal in mapId '"
                        + admin.getWorldId() + "'");
                }
            }
