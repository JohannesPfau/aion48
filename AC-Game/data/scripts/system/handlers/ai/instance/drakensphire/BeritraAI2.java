                            ...
                            switch (Rnd.get(1, 3)) {
                                case 1:
                                    if (!getOwner().getEffectController().isAbnormalPresentBySkillId(21610)) {
                                        SkillEngine.getInstance().getSkill(getOwner(), (getNpcId() == 236245 ? 21610 : 21610), 60, getOwner())
                                            .useSkill();
                                    }
                                    break;
                                case 2:
                                    if (!getOwner().getEffectController().isAbnormalPresentBySkillId(21611)) {
                                        SkillEngine.getInstance().getSkill(getOwner(), (getNpcId() == 236245 ? 21611 : 21611), 60, getOwner())
                                            .useSkill();
                                    }
                                    break;
                                case 3:
                                    if (!getOwner().getEffectController().isAbnormalPresentBySkillId(21612)) {
                                        SkillEngine.getInstance().getSkill(getOwner(), (getNpcId() == 236245 ? 21612 : 21612), 60, getOwner())
                                            .useSkill();
                                    }
                                    break;
                            }
