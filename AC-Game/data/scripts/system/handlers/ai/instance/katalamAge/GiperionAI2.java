...
public class GiperionAI2 extends AggressiveNpcAI2 {
    ...
    protected List<Integer> npcIds = new ArrayList<>();
    ...
    private void allNpcIds() {
        npcIds.clear();
        Collections.addAll(npcIds,
            new Integer[] { 231092, 231093, 231094, 231095, 231096, 231099, 231100, 231101, 233296, 233295, 233298, 233291, 233289 });
    }
