    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        ...
        if (dialogId == 10000) { // Emperor treasure room
            if (player.getInventory().decreaseByItemId(182006989, 1) && entryCount == 0) {
                entryCount++;
                TeleportService2.teleportTo(player, 300560000, instanceId, 74.292816f, 350.66525f, 285.14545f, (byte) 0,
                    TeleportAnimation.BEAM_ANIMATION);
            } else if (player.getInventory().decreaseByItemId(182006989, 1) && entryCount == 1) {
                entryCount++;
                TeleportService2.teleportTo(player, 300560000, instanceId, 375.25629f, 198.02574f, 306.84357f, (byte) 0,
                    TeleportAnimation.BEAM_ANIMATION);
            } else if (player.getInventory().decreaseByItemId(182006989, 1) && entryCount == 2) {
                entryCount++;
                TeleportService2.teleportTo(player, 300560000, instanceId, 335.55219f, 334.60947f, 458.5939f, (byte) 0,
                    TeleportAnimation.BEAM_ANIMATION);
            } else {
        ...
        if (dialogId == 10001) { // Empress treasure room
            if (player.getInventory().decreaseByItemId(182006990, 1) && entryCount == 0) {
                entryCount++;
                TeleportService2.teleportTo(player, 300560000, instanceId, 347.96069f, 41.424923f, 358.3918f, (byte) 0,
                    TeleportAnimation.BEAM_ANIMATION);
            } else if (player.getInventory().decreaseByItemId(182006990, 1) && entryCount == 1) {
                entryCount++;
                TeleportService2.teleportTo(player, 300560000, instanceId, 82.877762f, 240.61363f, 421.79004f, (byte) 0,
                    TeleportAnimation.BEAM_ANIMATION);
            } else if (player.getInventory().decreaseByItemId(182006990, 1) && entryCount == 2) {
                entryCount++;
                TeleportService2.teleportTo(player, 300560000, instanceId, 75.203018f, 432.58603f, 455.82312f, (byte) 0,
                    TeleportAnimation.BEAM_ANIMATION);
            } else {
        ...
        if (dialogId == 10002) { // Prince treasure room
            if (player.getInventory().decreaseByItemId(182006991, 1) && entryCount == 0) {
                entryCount++;
                TeleportService2.teleportTo(player, 300560000, instanceId, 409.74783f, 247.3778f, 516.4457f, (byte) 0,
                    TeleportAnimation.BEAM_ANIMATION);
            } else if (player.getInventory().decreaseByItemId(182006991, 1) && entryCount == 1) {
                entryCount++;
                TeleportService2.teleportTo(player, 300560000, instanceId, 181.56918f, 385.08932f, 616.1734f, (byte) 0,
                    TeleportAnimation.BEAM_ANIMATION);
            } else if (player.getInventory().decreaseByItemId(182006991, 1) && entryCount == 2) {
                entryCount++;
                TeleportService2.teleportTo(player, 300560000, instanceId, 177.63902f, 77.778755f, 466.1734f, (byte) 0,
                    TeleportAnimation.BEAM_ANIMATION);
            } else {
