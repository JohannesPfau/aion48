...
public class cmd_arena extends PlayerCommand {
    ...
    public void execute(final Player player, String... params) {
        ...
        if (player.isInArena()) {
            ...
            ThreadPoolManager.getInstance().schedule(new Runnable() {
                ...
                public void run() {
                    ...
                    if (!player.canLeaveArena()) {
                        PacketSendUtility.sendSpecMessage("Arena",
                            String.format("%s gives up the solo battle. Type '.arena' to join again.", player.getName()));
                    }
            ...
            if (player.getController().isInCombat() || player.isInPkMode() || player.isInDuoFFA() || player.isInPrison()
            ...
            if (player.arenaWaiting) {
                ...
                PacketSendUtility.sendBrightYellowMessageOnCenter(player,
                    String.format("Arena: %s removed from the waiting list. Type '.arena' to join again.", player.getName()));
            } else {
