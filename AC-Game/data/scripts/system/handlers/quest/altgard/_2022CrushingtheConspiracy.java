            ...
            switch (targetId) {
                case 203557: { // Suthran
                    if (env.getDialog() == DialogAction.QUEST_SELECT && var == 0) {
                        ...
                        TeleportService2.teleportTo(player, 220030000, 2452.6416f, 2551.4355f, 316.72693f, (byte) 88,
                ...
                case 700140: { // Abyss Gate Guardian Stone // TODO: add a check if Kuninasha is spawned already, to avoid multiple spawns.
                    if (var == 2) {
                        if (env.getDialog() == DialogAction.USE_OBJECT) {
                            QuestService.addNewSpawn(320030000, player.getInstanceId(), 214103, (float) 258.96942, (float) 239.16132,
                                (float) 217.90526, (byte) 94);
