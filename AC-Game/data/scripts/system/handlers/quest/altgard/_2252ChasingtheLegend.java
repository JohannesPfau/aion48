                ...
                switch (dialog) {
                    case USE_OBJECT:
                        ...
                        if (var == 0 && checkItemExistence(env, questActionItemId, 1, true)) {
                            ...
                            final Npc questMob = (Npc) QuestService.spawnQuestNpc(player.getWorldId(), player.getInstanceId(), questSpawnedNpcId,
                                npc.getX(), npc.getY(), npc.getZ(), npc.getHeading()); // Minushan's Spirit or Minushan's Drakie
