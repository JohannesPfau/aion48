                ...
                case 203992: { // Ophelos
                    switch (dialog) {
                        ...
                        case SETPRO3: {
                            ...
                            TeleportService2.teleportTo(player, 210020000, 645.600f, 436.980f, 331.875f, (byte) 119,
                ...
                case 203968: { // Corybantes
                    switch (dialog) {
                        ...
                        case SETPRO5: {
                            qs.setQuestVarById(0, var + 1);
                            updateQuestStatus(env);
                            TeleportService2.teleportTo(player, 210020000, 1056.378f, 345.040f, 306.911f, (byte) 119,
                                TeleportAnimation.BEAM_ANIMATION);
                            return true;
                        }
                        default:
                ...
                case 203987: { // Heratos
                    switch (dialog) {
                        ...
                        case SETPRO7: {
                            qs.setQuestVarById(0, var + 1);
                            updateQuestStatus(env);
                            TeleportService2.teleportTo(player, 210020000, 1526.212f, 521.0421f, 356.7938f, (byte) 119,
                                TeleportAnimation.BEAM_ANIMATION);
                            return true;
                        }
                        default:
