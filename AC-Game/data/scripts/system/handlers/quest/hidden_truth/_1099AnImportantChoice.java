            ...
            switch (targetId) {
                case 790001: { // Pernos
                    switch (env.getDialog()) {
                        ...
                        case SETPRO1: {
                            ...
                            TeleportService2.teleportTo(env.getPlayer(), 400010000, 2247.816f, 2189.872f, 2191.5242f, (byte) 36,
                ...
                case 700551: { // Fissure of Destiny
                    if (env.getDialog() == DialogAction.USE_OBJECT && var == 1) {
                        ...
                        TeleportService2.teleportTo(env.getPlayer(), 310120000, 56.932575f, 178.72818f, 228.89743f, (byte) 7,
                            TeleportAnimation.BEAM_ANIMATION);
                        return true;
                    }
                    break;
                ...
                case 205118: { // Lephar
                    switch (env.getDialog()) {
                        ...
                        case SETPRO2:
                        case SETPRO3:
                            TeleportService2.teleportTo(env.getPlayer(), 110010000, 1313.027f, 1512.1644f, 568.26025f, (byte) 118,
                                TeleportAnimation.BEAM_ANIMATION);
