            ...
            switch (targetId) {
                ...
                case 798975: { // Sulla
                    switch (dialog) {
                        ...
                        case SETPRO7: {
                            TeleportService2.teleportTo(env.getPlayer(), 110020000, 2183.7898f, 1569.909f, 1212.0791f, (byte) 102,
                ...
                case 798513: { // Machiah
                    switch (dialog) {
                        ...
                        case SETPRO8: {
                            TeleportService2.teleportTo(env.getPlayer(), 210060000, 2967.664f, 194.1034f, 171.58623f, (byte) 99,
                                TeleportAnimation.BEAM_ANIMATION);
                ...
                case 798225: { // Pyrrha
                    switch (dialog) {
                        ...
                        case SETPRO9: {
                            TeleportService2.teleportTo(env.getPlayer(), 210050000, 2697.243f, 1401.9658f, 370.45483f, (byte) 99,
                                TeleportAnimation.BEAM_ANIMATION);
                        ...
                        case SETPRO13: {
                            if (var == 12) {
                                if (player.getInventory().getItemCountByItemId(182206613) > 0) { // Bloody Greathammer
                                    ...
                                    TeleportService2.teleportTo(player, 300160000, newInstance.getInstanceId(), 795.28143f, 918.806f, 149.80243f,
                                        (byte) 73, TeleportAnimation.BEAM_ANIMATION);
                                    return true;
                                } else {
