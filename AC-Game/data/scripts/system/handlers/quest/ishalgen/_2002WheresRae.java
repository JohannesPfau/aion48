            ...
            switch (targetId) {
                    ...
                    switch (env.getDialog()) {
                        ...
                        case SETPRO5:
                            if (var == 12 || var == 99) {
                                ...
                                TeleportService2.teleportTo(player, 320010000, newInstance.getInstanceId(), 457.5762f, 426.71606f, 230.38448f,
                                    (byte) 76, TeleportAnimation.BEAM_ANIMATION);
                                return true;
                            }
                ...
                case 203538: // Cute Ribbit
                    if (var == 14 && env.getDialog() == DialogAction.USE_OBJECT) {
                        ...
                        PacketSendUtility.sendPacket(player, new SM_DIALOG_WINDOW(env.getVisibleObject().getObjectId(), 10));
                        QuestService.addNewSpawn(player.getWorldId(), player.getInstanceId(), 203553, npc.getX(), npc.getY(), npc.getZ(),
                            npc.getHeading());
