                    ...
                    switch (dialog) {
                        ...
                        case SETPRO2: {
                            if (var == 1 && player.getInventory().getItemCountByItemId(182215521) == 1) {
                                ...
                                TeleportService2.teleportTo(player, 301340000, newInstance.getInstanceId(), 243, 310, 396, (byte) 30,
                    ...
                    switch (dialog) {
                        ...
                        case SETPRO7: {
                            if (var == 6 && player.getInventory().getItemCountByItemId(182215520) == 1) {
                                TeleportService2.teleportTo(player, 600090000, 1360.71f, 937.16f, 155.57f, (byte) 0,
                                    TeleportAnimation.BEAM_ANIMATION);
