            ...
            switch (targetId) {
                case 204182: { // Heimdall
                    switch (dialog) {
                        ...
                        case SETPRO1: {
                            TeleportService2.teleportTo(player, 220010000, 388.1806f, 1896.387f, 327.62662f, (byte) 61,
                ...
                case 203550: { // Munin
                    switch (dialog) {
                        ...
                        case SETPRO10: {
                            TeleportService2.teleportTo(player, 120010000, 1292.0074f, 1214.6287f, 214.3387f, (byte) 11,
                                TeleportAnimation.BEAM_ANIMATION);
                    ...
                    switch (dialog) {
                        ...
                        case SETPRO5: {
                            if (var == 4) {
                                ...
                                TeleportService2.teleportTo(player, 320070000, newInstance.getInstanceId(), 253.66963f, 259.2077f, 125.8369f,
                                    (byte) 87, TeleportAnimation.BEAM_ANIMATION);
