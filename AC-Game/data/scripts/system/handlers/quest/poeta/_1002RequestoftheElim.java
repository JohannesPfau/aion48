                ...
                case 730008: { // Daminu
                    switch (dialog) {
                        ...
                        case SETPRO5: {
                            ...
                            TeleportService2.teleportTo(player, 310010000, newInstance.getInstanceId(), 53.002262f, 175.88441f, 229.1948f, (byte) 9,
                            ...
                            if (var == 20) {
                                ...
                                ThreadPoolManager.getInstance().schedule(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        TeleportService2.teleportTo(player, 210010000, 601.8938f, 1537.4147f, 115.93347f, (byte) 36,
                                            TeleportAnimation.BEAM_ANIMATION);
                                    }
                                }, 43000);
                                return true;
