                    ...
                    switch (env.getDialog()) {
                        ...
                        case SETPRO2:
                            if (var == 1) {
                                ...
                                TeleportService2.teleportTo(player, 210060000, 981.6369f, 3020.979f, 200.04276f, (byte) 119,
        ...
        if (qs != null && qs.getStatus() == QuestStatus.START) {
            ...
            if (target instanceof Npc) {
                ...
                if (npc.getNpcId() == 700390 && var == 4 && (bag.getItemCountByItemId(182208012) < 6)) {
                    QuestService.addNewSpawn(player.getWorldId(), player.getInstanceId(), 214552, (float) 239.66934, (float) 2734.8235,
                        (float) 76.56028, (byte) 81);
                    QuestService.addNewSpawn(player.getWorldId(), player.getInstanceId(), 214552, (float) 239.33173, (float) 2739.9043,
                        (float) 77.56217, (byte) 30);
                    return true;
                }
            }
        }
