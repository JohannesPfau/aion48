            ...
            switch (targetId) {
                case 203098: {
                    switch (dialog) {
                        ...
                        case SETPRO1: {
                            TeleportService2.teleportTo(player, 210030000, 2683.2085f, 1068.8977f, 199.375f, (byte) 60,
    ...
    public boolean onEnterWorldEvent(QuestEnv env) {
        ...
        if (qs.getStatus() == QuestStatus.START) {
            ...
            if (var == 2 && player.getWorldId() != 310030000) {
                ...
                QuestService.addNewSpawn(310030000, player.getInstanceId(), 233873, (float) 258.89917, (float) 237.20166, (float) 217.06035,
                    (byte) 0);
                return true;
            }
        }
