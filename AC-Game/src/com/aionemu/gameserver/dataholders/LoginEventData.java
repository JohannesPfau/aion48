...
public class LoginEventData {
    ...
    @XmlTransient
    private FastMap<Integer, LoginRewardTemplate> reward = new FastMap<>();

    @XmlTransient
    private THashMap<Integer, LoginRewardTemplate> activeEvents = new THashMap<>();

    @XmlTransient
    private THashMap<Integer, LoginRewardTemplate> allEvents = new THashMap<>();
    ...
    public List<LoginRewardTemplate> getAllEvents() {
        List<LoginRewardTemplate> result = new ArrayList<>();
