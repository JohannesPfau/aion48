...
public final class BufferUtils {
     ...
     *
     * @param vertices
     *            number of vertices that need to be held by the newly
     *            created buffer
     ...
     *            the buffer to insert into
     * @param index
     *            the postion to place the data; in terms of vectors not
     *            floats
     */
     ...
     * @param required
     *            minimum number of elements that should be remaining in
     *            the returned buffer
