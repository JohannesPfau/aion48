...
public class ItemActions {
    ...
    @XmlElements({ @XmlElement(name = "skilllearn", type = SkillLearnAction.class), @XmlElement(name = "extract", type = ExtractAction.class),
        ...
        @XmlElement(name = "tuning", type = TuningAction.class), @XmlElement(name = "pack", type = PackAction.class),
        @XmlElement(name = "stenchant", type = AuthorizeAction.class), @XmlElement(name = "multi_return_item", type = MultiReturnAction.class),
        @XmlElement(name = "godsocket", type = GodstoneAction.class), @XmlElement(name = "expreturn", type = ExpReturnAction.class) })
