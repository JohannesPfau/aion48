...
public class StigmaService {
    ...
    public static List<Stigmaa> getStigmaInfoUpToLevel(int n2, int n3) {
        ...
        ArrayList<Stigmaa> arrayList = new ArrayList<>();
            ...
            for (int i2 = n3; i2 <= 5000; ++i2) {
                ...
                for (SkillLearnTemplate skillLearnTemplate2 : arrskillLearnTemplate2 = DataManager.SKILL_TREE_DATA.getTemplatesForSkill(i2)) {
                    if (skillLearnTemplate2.getName().equalsIgnoreCase(string)) {
                        if (n2 < skillLearnTemplate2.getMinLevel())
                            continue;
                ...
                for (StigmaSkill sSkill : stigmaInfo.getSkills()) {
                    for (RequireSkill rs : si.getRequireSkill()) {
                        if (rs.getSkillIds().contains(sSkill.getSkillId())) {
                            PacketSendUtility.sendPacket(player, new SM_SYSTEM_MESSAGE(1300410,
                                new DescriptionId(resultItem.getItemTemplate().getNameId()), new DescriptionId(item.getItemTemplate().getNameId())));
                            return false;
                        }
                    }
                }
    ...
    public static void onPlayerLogin(Player player) {
        ...
        for (Item item22 : list) {
            List<Stigmaa> list3;
            if (!item22.getItemTemplate().isStigma())
                continue;
        ...
        for (Item item22 : list) {
            ...
            if (item22.getItemTemplate().isClassSpecific(player.getCommonData().getPlayerClass()))
                continue;
            AuditLogger.info(player, "Possible client hack not valid for class.");
            player.getEquipment().unEquipItem(item22.getObjectId(), 0);
        }
        ...
        switch (player.getPlayerClass()) {
            case GLADIATOR:
                if ((sStigma.size() == 6) && !hasInert) {
                    if (((sStigma.contains(140001119)) && (sStigma.contains(140001106))
                        && ((sStigma.contains(140001108)) || (sStigma.contains(140001107))))
                        || ((sStigma.contains(140001108)) && (sStigma.contains(140001107)))) {
                        player.getSkillList().addLinkedSkill(player, 641, 1);
                    } else if (((sStigma.contains(140001118)) && (sStigma.contains(140001104))
                        && ((sStigma.contains(140001103)) || (sStigma.contains(140001105))))
                        || ((sStigma.contains(140001103)) && (sStigma.contains(140001105)))) {
            ...
            case TEMPLAR:
                if ((sStigma.size() == 6) && !hasInert) {
                    if (((sStigma.contains(140001134)) && (sStigma.contains(140001122))
                        && ((sStigma.contains(140001120)) || (sStigma.contains(140001125))))
                        || ((sStigma.contains(140001120)) && (sStigma.contains(140001125)))) {
                        player.getSkillList().addLinkedSkill(player, 2919, 1);
                    } else if (((sStigma.contains(140001135)) && (sStigma.contains(140001123))
                        && ((sStigma.contains(140001124)) || (sStigma.contains(140001121))))
                        || ((sStigma.contains(140001124)) && (sStigma.contains(140001121)))) {
            ...
            case ASSASSIN:
                if ((sStigma.size() == 6) && !hasInert) {
                    if (((sStigma.contains(140001152)) && (sStigma.contains(140001138))
                        && ((sStigma.contains(140001139)) || (sStigma.contains(140001141))))
                        || ((sStigma.contains(140001139)) && (sStigma.contains(140001141)))) {
                        player.getSkillList().addLinkedSkill(player, 3326, 1);
                    } else if (((sStigma.contains(140001151)) && (sStigma.contains(140001136))
                        && ((sStigma.contains(140001140)) || (sStigma.contains(140001137))))
                        || ((sStigma.contains(140001140)) && (sStigma.contains(140001137)))) {
            ...
            case RANGER:
                if ((sStigma.size() == 6) && !hasInert) {
                    if (((sStigma.contains(140001172)) && (sStigma.contains(140001155))
                        && ((sStigma.contains(140001157)) || (sStigma.contains(140001153))))
                        || ((sStigma.contains(140001157)) && (sStigma.contains(140001153)))) {
                        player.getSkillList().addLinkedSkill(player, 1006, 1);
                    } else if (((sStigma.contains(140001173)) && (sStigma.contains(140001154))
                        && ((sStigma.contains(140001158)) || (sStigma.contains(140001156))))
                        || ((sStigma.contains(140001158)) && (sStigma.contains(140001156)))) {
            ...
            case SORCERER:
                if ((sStigma.size() == 6) && !hasInert) {
                    if (((sStigma.contains(140001191)) && (sStigma.contains(140001174))
                        && ((sStigma.contains(140001181)) || (sStigma.contains(140001178))))
                        || ((sStigma.contains(140001181)) && (sStigma.contains(140001178)))) {
                        player.getSkillList().addLinkedSkill(player, 1340, 1);
                    } else if (((sStigma.contains(140001192)) && (sStigma.contains(140001176))
                        && ((sStigma.contains(140001177)) || (sStigma.contains(140001184))))
                        || ((sStigma.contains(140001177)) && (sStigma.contains(140001184)))) {
            ...
            case SPIRIT_MASTER:
                if ((sStigma.size() == 6) && !hasInert) {
                    if (((sStigma.contains(140001209)) && (sStigma.contains(140001195))
                        && ((sStigma.contains(140001193)) || (sStigma.contains(140001194))))
                        || ((sStigma.contains(140001193)) && (sStigma.contains(140001194)))) {
                        player.getSkillList().addLinkedSkill(player, 3541, 1);
                    } else if (((sStigma.contains(140001210)) && (sStigma.contains(140001199))
                        && ((sStigma.contains(140001197)) || (sStigma.contains(140001196))))
                        || ((sStigma.contains(140001197)) && (sStigma.contains(140001196)))) {
            ...
            case CLERIC:
                if ((sStigma.size() == 6) && !hasInert) {
                    if (((sStigma.contains(140001246)) && (sStigma.contains(140001234))
                        && ((sStigma.contains(140001232)) || (sStigma.contains(140001233))))
                        || ((sStigma.contains(140001232)) && (sStigma.contains(140001233)))) {
                        player.getSkillList().addLinkedSkill(player, 3932, 1);
                    } else if (((sStigma.contains(140001245)) && (sStigma.contains(140001229))
                        && ((sStigma.contains(140001228)) || (sStigma.contains(140001230))))
                        || ((sStigma.contains(140001228)) && (sStigma.contains(140001230)))) {
            ...
            case CHANTER:
                if ((sStigma.size() == 6) && !hasInert) {
                    if (((sStigma.contains(140001226)) && (sStigma.contains(140001212))
                        && ((sStigma.contains(140001213)) || (sStigma.contains(140001211))))
                        || ((sStigma.contains(140001213)) && (sStigma.contains(140001211)))) {
                        player.getSkillList().addLinkedSkill(player, 1907, 1);
                    } else if (((sStigma.contains(140001227)) && (sStigma.contains(140001214))
                        && ((sStigma.contains(140001216)) || (sStigma.contains(140001215))))
                        || ((sStigma.contains(140001216)) && (sStigma.contains(140001215)))) {
            ...
            case RIDER:
                if ((sStigma.size() == 6) && !hasInert) {
                    if (((sStigma.contains(140001279)) && (sStigma.contains(140001264))
                        && ((sStigma.contains(140001269)) || (sStigma.contains(140001265))))
                        || ((sStigma.contains(140001269)) && (sStigma.contains(140001265)))) {
                        player.getSkillList().addLinkedSkill(player, 2852, 1);
                    } else if (((sStigma.contains(140001280)) && (sStigma.contains(140001266))
                        && ((sStigma.contains(140001268)) || (sStigma.contains(140001267))))
                        || ((sStigma.contains(140001268)) && (sStigma.contains(140001267)))) {
            ...
            case GUNNER:
                if ((sStigma.size() == 6) && !hasInert) {
                    if (((sStigma.contains(140001262)) && (sStigma.contains(140001249))
                        && ((sStigma.contains(140001247)) || (sStigma.contains(140001248))))
                        || ((sStigma.contains(140001247)) && (sStigma.contains(140001248)))) {
                        player.getSkillList().addLinkedSkill(player, 2368, 1);
                    } else if (((sStigma.contains(140001263)) && (sStigma.contains(140001251))
                        && ((sStigma.contains(140001252)) || (sStigma.contains(140001250))))
                        || ((sStigma.contains(140001252)) && (sStigma.contains(140001250)))) {
            ...
            case BARD:
                if ((sStigma.size() == 6) && !hasInert) {
                    if (((sStigma.contains(140001297)) && (sStigma.contains(140001285))
                        && ((sStigma.contains(140001283)) || (sStigma.contains(140001286))))
                        || ((sStigma.contains(140001283)) && (sStigma.contains(140001286)))) {
                        player.getSkillList().addLinkedSkill(player, 4483, 1);
                    } else if (((sStigma.contains(140001296)) && (sStigma.contains(140001281))
                        && ((sStigma.contains(140001284)) || (sStigma.contains(140001282))))
                        || ((sStigma.contains(140001284)) && (sStigma.contains(140001282)))) {
