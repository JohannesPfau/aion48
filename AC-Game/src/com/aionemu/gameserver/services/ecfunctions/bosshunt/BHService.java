...
public class BHService extends PVPManager {
    ...
    static FFA3D[] posMedium1 = new FFA3D[] { new FFA3D(722.40234f, 440.34232f, 103.73857f, 48), };
    //Abyssal Splinter 300220000
    static FFA3D[] posMedium2 = new FFA3D[] { new FFA3D(347.43463f, 741.6064f, 197.2789f, 49), };
    //Nochsana Training Camp 300030000
    static FFA3D[] posMedium3 = new FFA3D[] { new FFA3D(342.3624f, 332.31348f, 380.01395f, 49), };
    //Taloc's Hollow 300190000
    static FFA3D[] posMedium4 = new FFA3D[] { new FFA3D(567.2518f, 828.97205f, 1374.8302f, 49), };
    //Raksang Ruins 300610000
    static FFA3D[] posMedium5 = new FFA3D[] { new FFA3D(662.52765f, 668.46985f, 522.0487f, 49), };
