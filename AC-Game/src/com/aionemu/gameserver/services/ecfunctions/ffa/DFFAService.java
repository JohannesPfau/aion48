...
public class DFFAService extends PVPManager {
    ...
    WorldMapInstance mediumInstance1, mediumInstance2, mediumInstance3, mediumInstance4, mediumInstance5, mediumInstance6, mediumInstance7,
        mediumInstance8, mediumInstance9, mediumInstance10, mediumInstance11, mediumInstance12, mediumInstance13, mediumInstance14, mediumInstance15,
        mediumInstance16, mediumInstance17, mediumInstance18, mediumInstance19, mediumInstance20;
    ...
    static FFA3D[] posMedium1 = new FFA3D[] { new FFA3D(1571.5962f, 1392.0237f, 597.0612f, 48), new FFA3D(1505.6548f, 1555.5101f, 610.7626f, 70),
        new FFA3D(1413.7462f, 1566.5432f, 595.7288f, 70), new FFA3D(1433.7483f, 1620.9523f, 599.9493f, 71),
        new FFA3D(1192.256f, 1653.6671f, 593.6512f, 4), new FFA3D(1294.1083f, 1677.8041f, 596.8785f, 70),
        new FFA3D(1150.2633f, 1534.8066f, 584.875f, 10), };
    //fire temple 320100000
    static FFA3D[] posMedium2 = new FFA3D[] { new FFA3D(265.31871f, 200.28517f, 119.36553f, 35), new FFA3D(396.17816f, 274.7947f, 110.843392f, 64),
        new FFA3D(346.91217f, 351.30856f, 146.05597f, 53), new FFA3D(374.48663f, 85.15076f, 117.155655f, 20),
        new FFA3D(350.70593f, 262.632f, 118.461784f, 117), new FFA3D(385.9988f, 293.25034f, 115.05154f, 89),
        new FFA3D(405.82626f, 236.8875f, 121.88696f, 45), new FFA3D(416.8092f, 96.5659f, 117.30519f, 50),
        new FFA3D(207.5757f, 283.0724f, 125.883995f, 97), new FFA3D(123.43369f, 200.4345f, 100.31581f, 115), };
    //beshmundir temple 300170000
    static FFA3D[] posMedium3 = new FFA3D[] { new FFA3D(1036.9789f, 999.2163f, 287.47525f, 6), new FFA3D(1215.456f, 684.7193f, 251.2751f, 29),
        new FFA3D(1216.1144f, 751.0783f, 318.7667f, 29), new FFA3D(1398.1777f, 1320.5906f, 307.58472f, 79),
        new FFA3D(1409.508f, 1185.8265f, 294.5f, 81), new FFA3D(1160.6357f, 1224.2141f, 287.7014f, 105),
        new FFA3D(1131.3632f, 1107.2262f, 279.47992f, 105), new FFA3D(1330.9554f, 1130.5115f, 282.0f, 74), };
    //Padmarashka's Cave 320150000
    static FFA3D[] posMedium4 = new FFA3D[] { new FFA3D(373.51642f, 526.7331f, 66.87186f, 98), new FFA3D(504.54248f, 461.5506f, 76.91472f, 65),
        new FFA3D(310.20963f, 439.85443f, 77.18049f, 1), new FFA3D(413.03375f, 341.98602f, 81.135185f, 21),
        new FFA3D(620.0556f, 286.93393f, 68.769999f, 66), new FFA3D(633.11523f, 203.38213f, 67.89635f, 55),
        new FFA3D(541.0462f, 135.81851f, 69.32095f, 20), new FFA3D(486.1619f, 225.26633f, 69.42379f, 119), };
    //right wing chamber 300090000
    static FFA3D[] posMedium5 = new FFA3D[] { new FFA3D(264.3072f, 392.54553f, 103.24291f, 90), new FFA3D(183.22029f, 284.03632f, 103.13739f, 114),
        new FFA3D(160.68745f, 203.7044f, 103.137314f, 4), new FFA3D(201.93588f, 142.53561f, 103.13842f, 21),
        new FFA3D(262.58337f, 114.73569f, 103.13809f, 30), new FFA3D(344.65457f, 151.83511f, 103.13739f, 51),
        new FFA3D(359.42703f, 238.54097f, 103.13786f, 71), new FFA3D(319.14105f, 332.72894f, 103.13731f, 76), };
    //Kromede Trial 300230000
    static FFA3D[] posMedium6 = new FFA3D[] { new FFA3D(529.31964f, 621.6982f, 201.54883f, 30), new FFA3D(610.5367f, 640.8306f, 208.98755f, 30),
        new FFA3D(690.3266f, 507.05804f, 197.90062f, 30), new FFA3D(740.7479f, 530.34595f, 199.31773f, 30),
        new FFA3D(678.014f, 683.31976f, 200.28648f, 30), new FFA3D(570.5964f, 654.35895f, 206.9643f, 30),
        new FFA3D(495.8699f, 583.85645f, 216.10832f, 30), new FFA3D(512.5533f, 614.191f, 214.99915f, 30),
        new FFA3D(558.19995f, 795.9157f, 215.88853f, 30), new FFA3D(500.87433f, 783.68567f, 215.97673f, 30), };
    //rentus base 300280000
    static FFA3D[] posMedium7 = new FFA3D[] { new FFA3D(562.91125f, 588.8692f, 154.125f, 70), new FFA3D(508.31497f, 613.87006f, 158.67757f, 115),
        new FFA3D(455.29355f, 529.4532f, 139.5f, 7), new FFA3D(539.53296f, 506.81046f, 175.37022f, 51),
        new FFA3D(424.4234f, 431.25925f, 149.49472f, 42), new FFA3D(460.48907f, 479.49136f, 179.4234f, 55),
        new FFA3D(362.9009f, 465.18146f, 138.66933f, 7), new FFA3D(309.95837f, 638.1602f, 150.47337f, 111),
        new FFA3D(229.74135f, 719.5911f, 164.58719f, 116), new FFA3D(210.56203f, 498.70352f, 197.83089f, 24),
        new FFA3D(271.69495f, 655.4851f, 180.66493f, 55), new FFA3D(229.812594f, 571.3857f, 178.48009f, 26),
        new FFA3D(143.538f, 247.86418f, 209.81859f, 27), new FFA3D(217.02643f, 638.2475f, 182.34702f, 11), };
    //Udas Temple
    static FFA3D[] posMedium8 = new FFA3D[] { new FFA3D(636.5956f, 654.64496f, 133.23831f, 105), new FFA3D(826.54834f, 484.16077f, 134.95059f, 58),
        new FFA3D(787.7538f, 410.05258f, 131.90742f, 118), new FFA3D(513.6373f, 505.6693f, 131.42784f, 61),
        new FFA3D(508.0596f, 408.69284f, 134.42802f, 32), new FFA3D(510.80237f, 700.32184f, 126.06522f, 86), };

    //ohpidan bridge 300590000
    static FFA3D[] posMedium9 = new FFA3D[] { new FFA3D(766.0864f, 570.65594f, 573.3696, 36), new FFA3D(562.8296f, 521.80255f, 607.89075f, 87),
        new FFA3D(437.63663f, 496.52597f, 604.8871f, 2), new FFA3D(645.59314f, 420.77634f, 606.57635f, 44),
        new FFA3D(666.2821f, 474.97546f, 601.1673f, 112), new FFA3D(758.0605f, 576.4918f, 572.875f, 87), };
    //sulfur
    static FFA3D[] posMedium10 = new FFA3D[] { new FFA3D(463.5722f, 347.48862f, 162.81717f, 30), new FFA3D(463.30612f, 580.02344f, 165.77994f, 90),
        new FFA3D(390.14612f, 552.9489f, 165.77994f, 110), new FFA3D(384.9894f, 468.80222f, 164.01689f, 5),
        new FFA3D(417.1364f, 390.10526f, 165.7726f, 24), new FFA3D(534.6254f, 403.95004f, 166.13959f, 46),
        new FFA3D(541.2394f, 480.92896f, 164.01666f, 60), new FFA3D(535.5123f, 529.41223f, 165.77994f, 74),
        new FFA3D(463.056f, 491.49872f, 163.9515f, 91), };
    //autoram sky fortress - Open Door
    static FFA3D[] posMedium11 = new FFA3D[] { new FFA3D(672.3723f, 68.6072f, 612.4829f, 90), //300240000
    ...
    //Bio Lab - Open Door
    static FFA3D[] posMedium12 = new FFA3D[] { new FFA3D(204.69553f, 205.26663f, 132.83458f, 8), //310050000
    ...
    static FFA3D[] posMedium13 = new FFA3D[] { new FFA3D(602.1943f, 527.3014f, 200.05792f, 59), //320110000
    ...
    static FFA3D[] posMedium14 = new FFA3D[] { new FFA3D(360.72992f, 259.04083f, 311.36432f, 59), //301270000
    ...
    static FFA3D[] posMedium15 = new FFA3D[] { new FFA3D(407.3566f, 403.2982f, 245.10768f, 29), new FFA3D(448.5527f, 474.07068f, 242.01869f, 59),
        new FFA3D(369.0938f, 474.54498f, 242.00453f, 0), new FFA3D(407.2672f, 555.09717f, 231.1734f, 90),
        new FFA3D(511.41748f, 511.89008f, 222.5006f, 29), new FFA3D(511.44348f, 594.0056f, 222.48643f, 90),
        new FFA3D(592.1598f, 554.5269f, 211.6554f, 60), new FFA3D(549.29987f, 450.31366f, 202.9827f, 119),
        new FFA3D(633.22046f, 450.4f, 202.96854f, 59), new FFA3D(591.70276f, 399.59564f, 206.53279f, 30), };
    //Runatorium
    static FFA3D[] posMedium16 = new FFA3D[] {
        //RightSide
        new FFA3D(260.2722f, 167.6338f, 79.430855f, 44), new FFA3D(199.78496f, 251.69586f, 85.185585f, 92),
        new FFA3D(211.33122f, 251.76952f, 85.185585f, 35), new FFA3D(211.61511f, 259.1576f, 89.4588f, 0),
        //Middle
        new FFA3D(238.5478f, 284.54166f, 89.3f, 102), new FFA3D(264.62488f, 295.25867f, 89.29f, 89), new FFA3D(276.17746f, 271.65524f, 92.94253f, 76),
        new FFA3D(301.88004f, 259.1435f, 89.27f, 60), new FFA3D(289.96518f, 233.80406f, 89.3f, 44), new FFA3D(264.80997f, 223.6196f, 89.31f, 30),
        new FFA3D(253.2836f, 247.00967f, 92.94253f, 15),
        //Left side
        new FFA3D(211.17525f, 252.44656f, 85.17249f, 90), new FFA3D(199.97333f, 252.09602f, 85.17249f, 94),
        new FFA3D(199.31203f, 191.69177f, 80.602165f, 14), new FFA3D(209.81206f, 190.35938f, 80.21404f, 46),
        new FFA3D(197.88922f, 201.4963f, 80.21404f, 101), new FFA3D(259.93085f, 168.99104f, 79.430855f, 45),
        new FFA3D(199.5456f, 192.03802f, 80.602165f, 15), };
    //Draupnir Cave
    static FFA3D[] posMedium17 = new FFA3D[] { new FFA3D(637.9372f, 411.40445f, 319.44244f, 37), new FFA3D(677.406f, 468.62378f, 316.19058f, 2),
        new FFA3D(765.5092f, 502.0949f, 319.92065f, 96), new FFA3D(872.62756f, 533.41815f, 329.7143f, 71),
        new FFA3D(823.7476f, 426.47595f, 318.2671f, 55), new FFA3D(808.12244f, 370.9118f, 320.3139f, 44),
        new FFA3D(726.0071f, 365.9905f, 323.41275f, 9), new FFA3D(715.15186f, 432.8395f, 318.7473f, 7),
        new FFA3D(765.1226f, 445.41638f, 320.01462f, 48), new FFA3D(817.96515f, 498.5655f, 319.70627f, 76),
    ...
    private void TeleChangeMap(Player player) {
        TeleportService2.teleportTo(player, worldNumber, instance.getInstanceId(), (float) loc.x, (float) loc.y, (float) loc.z, (byte) loc.h,
    ...
    public void TeleIn(Player player) {
        ...
        if (player.isInDuoFFA()) {
                ...
                for (Player member : group.getMembers()) {
                    if (player != member) {
                        if (!member.getLifeStats().isAlreadyDead() && member.isOnline()) {
                            TeleportService2.teleportTo(player, worldNumber, instance.getInstanceId(), member.getX(), member.getY(), member.getZ(),
                                (byte) member.getHeading(), TeleportAnimation.JUMP_AIMATION_3);
                            PacketSendUtility.sendWhiteMessageOnCenter(player, "[2v2v2] You are teleported to your team mate.");
                        } else {
                            TeleportService2.teleportTo(player, worldNumber, instance.getInstanceId(), (float) loc.x, (float) loc.y, (float) loc.z,
                                (byte) loc.h, TeleportAnimation.JUMP_AIMATION_3);
                        }
                    }
                }
            } else {
            ...
            PlayerGroup group = player.getPlayerGroup2();
            for (Player member : group.getMembers()) {
                TeleportService2.teleportTo(member, worldNumber, instance.getInstanceId(), (float) loc.x, (float) loc.y, (float) loc.z, (byte) loc.h,
                    TeleportAnimation.JUMP_AIMATION_3);
                resetStart(member);
            }
            log.info(String.format("[2v2v2] %s's Team Enter - Map: %s", player.getName(), worldName));
            if (instance != null && getPlayerCountDFFA(instance) > 1) {
                PacketSendUtility.sendSpecMessage("2v2v2",
                    player.getName() + "'s team has joined 2v2v2 with " + getPlayerCountDFFA(instance) + " players.");
            } else {
    ...
    public void TeleOut(Player player) {
        ...
        if (player.world() != 0) {
            TeleportService2.teleportTo(player, player.world(), player.locX(), player.locY(), player.locZ(), (byte) player.locH(),
                TeleportAnimation.JUMP_AIMATION_3);
        } else {
        ...
        if ((mac1 != null) && (mac2 != null)) {
            if ((ip1.equalsIgnoreCase(ip2)) && (mac1.equalsIgnoreCase(mac2))) {
                AuditLogger.info(winner,
                    "[TradeKillAlert] You really need to check player " + winner.getName() + " and " + loser.getName()
                ...
                PacketSendUtility.sendMessage(winner,
                    "[TradeKillAlert] You lost [item:" + omegaId + "] x 1 and [item:" + tsId + "] x 1 item(s) for Trade Killing!"); // item lose Item msg
            ...
            if (ip1.equalsIgnoreCase(ip2)) {
                AuditLogger.info(winner, "[TradeKillAlert] Possible chances that " + winner.getName() + " and " + loser.getName()
                    + " are trade killing in FFA. They have same ip " + ip1 + ".");
                AuditLogger.info(winner,
                    "[TradeKillAlert] If not, they are in some kinda cafe, with same network. OR USING SAME WTFAST Connection!!");
            }
        }
    }
    ...
    private void throwStreakAnnouncement(Player winner) {
        if (winner.getSpecialKills() == 5) {
            PacketSendUtility.sendAnnounceMessage(
                "[2v2v2] " + winner.getName() + " is your new Enemy! +10 Hero Points  (Kills: " + winner.getSpecialKills() + ")",
                ChatType.BRIGHT_YELLOW_CENTER, false);
            ItemService.addItem(winner, 166030005, 1);
        } else if (winner.getSpecialKills() == 10) {
            PacketSendUtility.sendAnnounceMessage(
                "[2v2v2] " + winner.getName() + " is the War Champion! +15 Hero Points (Kills: " + winner.getSpecialKills() + ")",
                ChatType.BRIGHT_YELLOW_CENTER, false);
            ItemService.addItem(winner, 166030005, 1);
        } else if (winner.getSpecialKills() == 15) {
            PacketSendUtility.sendAnnounceMessage(
                "[2v2v2] " + winner.getName() + " wants more blood! +20 Hero Points (Kills: " + winner.getSpecialKills() + ")",
                ChatType.BRIGHT_YELLOW_CENTER, false);
            ItemService.addItem(winner, 166030005, 1);
        } else if (winner.getSpecialKills() == 20) {
            PacketSendUtility.sendAnnounceMessage(
                "[2v2v2] " + winner.getName() + " is like a crazy monster! +25 Hero Points (Kills: " + winner.getSpecialKills() + ")",
                ChatType.BRIGHT_YELLOW_CENTER, false);
            ItemService.addItem(winner, 166030005, 1);
        } else if (winner.getSpecialKills() == 25) {
            PacketSendUtility.sendAnnounceMessage("[2v2v2] " + winner.getName() + " is a Killing Machine! Go Hunt Him Down (+30 HP)",
                ChatType.BRIGHT_YELLOW_CENTER, false);
            ItemService.addItem(winner, 166030005, 1);
        } else if (winner.getSpecialKills() == 30) {
            PacketSendUtility.sendAnnounceMessage(
                "[2v2v2] " + winner.getName() + ", Are you okay? " + winner.getSpecialKills() + " fucking kills?? (+35 HP)",
                ChatType.BRIGHT_YELLOW_CENTER, false);
            ItemService.addItem(winner, 166030005, 1);
        } else if (winner.getSpecialKills() == 35) {
            ItemService.addItem(winner, 166030005, 1);
            PacketSendUtility.sendAnnounceMessage("[2v2v2] " + winner.getName() + " is a BOSS, certified KILLER! (+40 HP)",
                ChatType.BRIGHT_YELLOW_CENTER, false);
            ...
            ItemService.addItem(winner, 166030005, 1);
            PacketSendUtility.sendAnnounceMessage("[2v2v2] " + winner.getName() + " knows the Enemies best! (+50 HP)", ChatType.BRIGHT_YELLOW_CENTER,
                false);
