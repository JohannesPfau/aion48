...
public class FFaService extends PVPManager {
    ...
    //Haramel 300200000
    static FFA3D[] posMedium1 = new FFA3D[] { new FFA3D(173.65646f, 20.642525f, 144.2249f, 48), new FFA3D(177.50137f, 54.633404f, 144.31184, 70),
        new FFA3D(65.592285f, 103.332886f, 139.21887f, 70), new FFA3D(147.95638f, 145.66255f, 144.28432f, 71),
        new FFA3D(222.8991f, 143.64795f, 137.24051f, 4), new FFA3D(196.22012, 224.88269f, 127.297775f, 70),
        new FFA3D(259.68097f, 214.05086, 88.951996, 10), };
    //Steelrake  300100000
    static FFA3D[] posMedium2 = new FFA3D[] { new FFA3D(295.22342f, 594.04926f, 952.03534f, 45), new FFA3D(331.15668f, 546.1082f, 952.017f, 45),
        new FFA3D(385.88788f, 598.3644f, 946.0964f, 45), new FFA3D(314.60825f, 604.8099f, 953.8755f, 45),
        new FFA3D(416.053f, 618.0517f, 948.10394f, 50), new FFA3D(412.55984f, 561.04663f, 946.0964f, 97),
        new FFA3D(324.9939f, 563.54517f, 953.76324f, 45), new FFA3D(406.02325f, 582.67944f, 948.04694f, 45),
        new FFA3D(404.43176f, 503.80304f, 944.6922f, 115), };
    //Hexway 300700000
    static FFA3D[] posMedium3 = new FFA3D[] { new FFA3D(672.7278f, 606.0872f, 321.21414f, 35), new FFA3D(671.12964f, 548.0154f, 335.33472f, 53),
        new FFA3D(573.454f, 574.33246f, 351.15314f, 20), new FFA3D(496.35623f, 607.3109f, 354.911f, 117),
        new FFA3D(281.05402f, 741.2451f, 364.93622f, 89), new FFA3D(329.2735f, 607.40625f, 362.06534f, 45),
        new FFA3D(502.37585f, 480.88242f, 352.70825f, 50), };
    //Adma StrongHold 320130000
    static FFA3D[] posMedium4 = new FFA3D[] { new FFA3D(477.3009f, 829.53735f, 164.83f, 35), new FFA3D(412.77263f, 766.42993f, 157.3499f, 64),
        new FFA3D(418.8922f, 734.38824f, 156.48161f, 53), new FFA3D(511.591f, 723.5784f, 158.40771f, 20),
        new FFA3D(499.9079f, 665.70013f, 162.78363f, 117), new FFA3D(445.4567f, 572.82654f, 162.26096f, 89),
        new FFA3D(430.8684f, 635.88104f, 163.3105f, 45), new FFA3D(405.17413f, 654.0031f, 168.9041f, 50),
        new FFA3D(355.19757f, 604.04974f, 168.9041f, 50), };
    //Chantra Dredgion 300110000
    static FFA3D[] posMedium5 = new FFA3D[] { new FFA3D(485.1806f, 306.4124f, 402.696f, 35), new FFA3D(468.0433f, 583.24805f, 391.57822f, 64),
        new FFA3D(422.15012f, 467.68222f, 393.14484f, 53), new FFA3D(318.10907f, 403.9567f, 412.34094f, 20),
        new FFA3D(415.9837f, 567.6851f, 410.72897f, 117), new FFA3D(401.1345f, 693.84625f, 402.20755f, 89),
        new FFA3D(484.84583f, 771.5248f, 388.9195f, 45), new FFA3D(559.26385f, 698.91876f, 402.20535f, 45),
        new FFA3D(587.76495f, 540.60944f, 409.4695f, 45), new FFA3D(587.76495f, 540.60944f, 409.4695f, 45),
        new FFA3D(650.5343f, 410.8248f, 412.2131f, 45), new FFA3D(485.2726f, 859.8147f, 417.9915f, 50), };
    ...
    private void throwStreakAnnouncement(Player winner) {
        if (winner.getSpecialKills() == 5) {
            PacketSendUtility.sendAnnounceMessage(
                "[FFA] " + winner.getName() + " is your new Enemy! +10 Hero Points  (Kills: " + winner.getSpecialKills() + ")",
            ...
            PacketSendUtility.sendAnnounceMessage(
                "[FFA] " + winner.getName() + " is the War Champion! +15 Hero Points (Kills: " + winner.getSpecialKills() + ")",
                ChatType.BRIGHT_YELLOW_CENTER, false);
            ItemService.addItem(winner, 166030005, 1);
            InGameShopEn.getInstance().addToll(winner, 10);
            PacketSendUtility.sendMessage(winner, "You have receive 10 tolls. Totals: " + winner.getPlayerAccount().getToll());
            ...
            PacketSendUtility.sendAnnounceMessage(
                "[FFA] " + winner.getName() + " wants more blood! +20 Hero Points (Kills: " + winner.getSpecialKills() + ")",
                ChatType.BRIGHT_YELLOW_CENTER, false);
            ItemService.addItem(winner, 166030005, 1);
            InGameShopEn.getInstance().addToll(winner, 10);
            PacketSendUtility.sendMessage(winner, "You have receive 10 tolls. Totals: " + winner.getPlayerAccount().getToll());
            ...
            PacketSendUtility.sendAnnounceMessage(
                "[FFA] " + winner.getName() + " is like a crazy monster! +25 Hero Points (Kills: " + winner.getSpecialKills() + ")",
                ChatType.BRIGHT_YELLOW_CENTER, false);
            ItemService.addItem(winner, 166030005, 1);
            InGameShopEn.getInstance().addToll(winner, 10);
            PacketSendUtility.sendMessage(winner, "You have receive 10 tolls. Totals: " + winner.getPlayerAccount().getToll());
        } else if (winner.getSpecialKills() == 25) {
            PacketSendUtility.sendAnnounceMessage("[FFA] " + winner.getName() + " is a Killing Machine! Go Hunt Him Down (+30 HP)",
                ChatType.BRIGHT_YELLOW_CENTER, false);
            ItemService.addItem(winner, 166030005, 1);
            InGameShopEn.getInstance().addToll(winner, 10);
            PacketSendUtility.sendMessage(winner, "You have receive 10 tolls. Totals: " + winner.getPlayerAccount().getToll());
            ...
            PacketSendUtility.sendAnnounceMessage(
                "[FFA] " + winner.getName() + ", Are you okay? " + winner.getSpecialKills() + " fucking kills?? (+35 HP)",
                ChatType.BRIGHT_YELLOW_CENTER, false);
            ItemService.addItem(winner, 166030005, 1);
            InGameShopEn.getInstance().addToll(winner, 10);
            PacketSendUtility.sendMessage(winner, "You have receive 10 tolls. Totals: " + winner.getPlayerAccount().getToll());
            ...
            InGameShopEn.getInstance().addToll(winner, 10);
            PacketSendUtility.sendMessage(winner, "You have receive 10 tolls. Totals: " + winner.getPlayerAccount().getToll());
            PacketSendUtility.sendAnnounceMessage("[FFA] " + winner.getName() + " is a BOSS, certified KILLER! (+40 HP)",
                ChatType.BRIGHT_YELLOW_CENTER, false);
            ...
            InGameShopEn.getInstance().addToll(winner, 10);
            PacketSendUtility.sendMessage(winner, "You have receive 10 tolls. Totals: " + winner.getPlayerAccount().getToll());
            PacketSendUtility.sendAnnounceMessage("[FFA] " + winner.getName() + " knows the Enemies best! (+50 HP)", ChatType.BRIGHT_YELLOW_CENTER,
                false);
